...
import { GET } from "@/app/api/users/[username]/likes/route";

function makeRequest(params: Record<string, string> = {}): NextRequest {
  const url = new URL("http://localhost/api/users/testuser/likes");
...
describe("GET /api/users/:username/likes — input validation", () => {
...
describe("GET /api/users/:username/likes — missing API key", () => {
...
describe("GET /api/users/:username/likes — upstream URL construction", () => {
  it("interpolates the username into the upstream URL", async () => {
    ...
    expect(calledUrl).toContain("/users/johndoe/likes");
  });
